...
CREATE TABLE `transaction_table` (
  ...
  `date` date NOT NULL,
  `customer_perDay` int NOT NULL,
  `quantity_sale_perDay` int NOT NULL,
  `revenue_perDay` double NOT NULL,
...
INSERT INTO `transaction_table` VALUES (1,'2023-01-24',2,5,10),(2,'2024-01-25',5,6,16),(3,'2024-01-26',4,5,12.5),(4,'2024-01-27',3,4,10);
